...
class LogoutConfirmationSheet extends StatelessWidget {
  ...
  const LogoutConfirmationSheet({super.key, required this.onConfirmLogout});
  ...
  Widget _buildConstrainedBottomSheet(BuildContext context) {
    return Center(
      child: Container(
        width: context.responsive<double>(xs: 340, md: 400, lg: 450, xl: 500),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: const Icon(Icons.logout, color: AppTheme.warningColor, size: 32),
        ),
