...
class AppHeader extends StatelessWidget {
  ...
  Widget _buildDrawerHeader(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: backgroundColor ?? AppTheme.primaryColor),
      child: Column(
  ...
  Widget _buildAppBarHeader(BuildContext context) {
    return AppBar(
      title: Column(
        ...
        children: [
          AppText.title(title, color: textColor ?? AppTheme.onSurface),
          if (subtitle != null) ...[
            AppText.caption(
              subtitle!,
  ...
  Widget _buildCompactHeader(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          if (showLogo) ...[customLogo ?? AppLogo.small(), const SizedBox(width: 8)],
          Expanded(
            child: AppText.body(
              title,
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    AppText.heading(title, color: textColor ?? AppTheme.onSurface),
                    if (subtitle != null) ...[
                      const SizedBox(height: 4),
                      AppText.body(
                        subtitle!,
  ...
  Widget? _buildLeading() {
    ...
    if (showMenuButton) {
      return AppMenuButton(onPressed: onMenuPressed);
    }
...
enum HeaderVariant { standard, drawer, appBar, compact, page }
