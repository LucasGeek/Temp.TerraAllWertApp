...
abstract class AppEnv {
  @EnviedField(varName: 'GRAPHQL_ENDPOINT', defaultValue: 'http://localhost:8080/graphql')
  static const String graphqlEndpoint = _AppEnv.graphqlEndpoint;
  
  @EnviedField(varName: 'GRAPHQL_WS_ENDPOINT', defaultValue: 'ws://localhost:8080/ws')
